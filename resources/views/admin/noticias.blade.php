@include('include.head-admin')
    ...
    <div class="row cuerpo-admin">
      <div class="row titulo center">
        ...
        <div class="row">
            <a href="noticia-formulario" class="btn-floating btn-large waves-effect red"><i class="material-icons">add</i></a>
               ...
               <tbody id="filas">
                 @forelse($publicaciones as $publicacion)
                    <tr id="fila{{$publicacion->id}}">
                       ...
                       <td><a href="noticia-formulario?id={{$publicacion->id}}" class="btn green"><i class="material-icons">edit</i></a></td>
                     </tr>
                 @empty
                     <tr id="filaempty">
